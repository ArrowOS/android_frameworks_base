...
#include <vendor/arrow/power/1.0/ILineagePower.h>
#include "JNIHelp.h"
#include "jni.h"
...
using vendor::arrow::power::V1_0::LineageFeature;
...
sp<vendor::arrow::power::V1_0::ILineagePower> gLineagePowerHalV1_0 = nullptr;
...
bool getLineagePowerHal() {
    if (gLineagePowerHalExists && gLineagePowerHalV1_0 == nullptr) {
        gLineagePowerHalV1_0 = vendor::arrow::power::V1_0::ILineagePower::getService();

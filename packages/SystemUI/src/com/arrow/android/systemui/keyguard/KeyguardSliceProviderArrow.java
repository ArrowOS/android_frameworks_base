package com.arrow.android.systemui.keyguard;
...
public class KeyguardSliceProviderArrow extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderArrow> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderArrow keyguardSliceProviderArrow, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderArrow);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderArrow.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderArrow keyguardSliceProviderArrow;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderArrow = (KeyguardSliceProviderArrow) mProviderReference.get();
            }
            if (keyguardSliceProviderArrow != null) {
                keyguardSliceProviderArrow.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderArrow#onBindSlice");
        Slice slice;

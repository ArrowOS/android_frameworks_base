...
@SysUISingleton
public class ArrowServices extends VendorServices {
    ...
    @Inject
    public ArrowServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);

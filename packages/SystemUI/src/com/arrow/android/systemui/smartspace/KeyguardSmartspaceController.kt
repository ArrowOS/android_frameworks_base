package com.arrow.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.arrow.android.systemui.keyguard.KeyguardSliceProviderArrow"), 1, 1)
        } else {

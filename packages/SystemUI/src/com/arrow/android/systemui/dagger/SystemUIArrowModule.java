...
import static com.arrow.android.systemui.Dependency.*;
...
import com.arrow.android.systemui.assist.AssistManagerGoogle;
...
public abstract class SystemUIArrowModule {
    ...
    @Binds
    abstract ThemeOverlayController provideThemeOverlayController(ThemeOverlayControllerArrow themeOverlayController);

    @Provides
    @SysUISingleton
    static ArrowServices provideArrowServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> lazy, Lazy<ColumbusServiceWrapper> lazyB) {
        return new ArrowServices(context, uiEventLogger, lazy, lazyB);
    }

...
public abstract class SystemUIArrowModule {
    ...
    @Provides
    @SysUISingleton
    static ArrowServices provideArrowServices(Context context, UiEventLogger uiEventLogger, Lazy<ColumbusServiceWrapper> lazyB) {
        return new ArrowServices(context, uiEventLogger, lazyB);
    }

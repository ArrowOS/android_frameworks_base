...
import com.android.systemui.arrow.ArrowSettingsServiceImpl;
...
public abstract class DependencyBinder {
     ...
     */
    @Binds
    public abstract ArrowSettingsService provideArrowSettingsService(
            ArrowSettingsServiceImpl controllerImpl);
}

...
public class StatusBarWeatherImageSB extends ImageView implements
    ...
    public StatusBarWeatherImageSB(Context context) {
        this(context, null);
    }

    public StatusBarWeatherImageSB(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StatusBarWeatherImageSB(Context context, AttributeSet attrs, int defStyle) {

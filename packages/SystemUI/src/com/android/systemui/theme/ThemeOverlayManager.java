...
class ThemeOverlayManager {
    ...
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_ARROW =
    ...
    ThemeOverlayManager(OverlayManager overlayManager, Executor executor,
        ...
        mTargetPackageToCategories.put(SETTINGS_PACKAGE,
                Sets.newHashSet(OVERLAY_CATEGORY_ICON_SETTINGS, OVERLAY_CATEGORY_ARROW));
        ...
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_ARROW, ANDROID_PACKAGE);
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_ICON_SYSUI, SYSUI_PACKAGE);
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_ARROW, SETTINGS_PACKAGE);

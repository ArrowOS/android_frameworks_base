...
public class MobileSignalController extends SignalController<MobileState, MobileIconGroup> {
    ...
    private void registerImsListeners() {
        try {
            Log.d(mTag, "register CapabilitiesCallback and RegistrationCallback");
    ...
    private void unregisterImsListeners() {
        try {
            Log.d(mTag, "unregister CapabilitiesCallback and RegistrationCallback");
            ...
            Log.e(mTag, "unable to unregister listeners", e);
        }
    }

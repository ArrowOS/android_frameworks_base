...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mBattery, mClock, mWeatherTextView, mWeatherImageView, mCenterClock, mRightClock, mNetworkTraffic;
    ...
    public void init() {
        ...
        mNetworkTraffic.setVisibility(
                ArrowUtils.hasNotch(mView.getContext()) ? View.GONE : View.VISIBLE);

...
public class QSPanel extends LinearLayout implements Tunable, Callback, BrightnessMirrorListener,
    ...
    protected void onAttachedToWindow() {
        ...
        Dependency.get(ArrowSettingsService.class).addStringObserver(this, QS_SHOW_AUTO_BRIGHTNESS);
        Dependency.get(ArrowSettingsService.class).addStringObserver(this, QS_SHOW_BRIGHTNESS_SLIDER);
    ...
    public void onStringSettingChanged(String key, String newValue) {
        if (DEBUG) Log.d(TAG, "onStringSettingChanged " + key + " -> " + newValue);

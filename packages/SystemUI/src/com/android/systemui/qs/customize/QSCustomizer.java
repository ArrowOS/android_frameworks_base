...
public class QSCustomizer extends LinearLayout implements OnMenuItemClickListener,
    ...
    private void attachSettings() {
        Dependency.get(ArrowSettingsService.class).addIntObserver(this, Settings.System.QS_LAYOUT_COLUMNS);
    ...
    private int getSettingsColumns() {
        ...
        int columns = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.QS_LAYOUT_COLUMNS, mResourceColumns,
                UserHandle.USER_CURRENT);
        int columnsLandscape = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.QS_LAYOUT_COLUMNS_LANDSCAPE, mResourceColumns,
                UserHandle.USER_CURRENT);

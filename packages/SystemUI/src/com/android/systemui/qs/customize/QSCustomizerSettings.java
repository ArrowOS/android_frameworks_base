...
public class QSCustomizerSettings extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        TriStateToggleButton showBrightnessSlider = findViewById(R.id.qs_customize_settings_brightness_slider);
        int showBrightnessSliderValue = Settings.Secure.getIntForUser(
                ...
                UserHandle.USER_CURRENT);
        showBrightnessSlider.setToggleStatus(showBrightnessSliderValue);
        showBrightnessSlider.setOnToggleChanged(new TriStateToggleButton.OnToggleChanged() {
            @Override
            public void onToggle(TriStateToggleButton.ToggleStatus toggleStatus, boolean booleanToggleStatus, int toggleIntValue) {
                Settings.Secure.putIntForUser(mContext.getContentResolver(),
                    Settings.Secure.QS_SHOW_BRIGHTNESS_SLIDER, toggleIntValue,
                    UserHandle.USER_CURRENT);
            }
        });
